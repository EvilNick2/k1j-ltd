...
<nav>
    ...
    <div class="links right">
        ...
        <?php if (isset($currentPage) && $currentPage === 'login'): ?>
            ...
            <?php else: ?>
                <a class="link-2-color button-2" href="register.php">Register</a>
            <?php endif; ?>
        <?php elseif (isset($currentPage) && $currentPage === 'profile'): ?>
					<?php if (isset($_SESSION['loggedin'])): ?>
						<a class="link-2-color button-2" href="../php/logout.php">Logout</a>
					<?php else: ?>
						<a class="link-2-color button-2" href="login.php">Login</a>
					<?php endif; ?>
        <?php else: ?>
            <?php if (isset($_SESSION['loggedin'])): ?>
                <?php $firstName = explode(' ', $_SESSION['name'])[0]; ?>
